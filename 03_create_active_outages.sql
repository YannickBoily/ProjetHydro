CREATE OR REPLACE TABLE active_outages AS
...
SELECT
    ...
    DATE_DIFF('second', r.start_time, r.captured_at) / 3600.0 AS outage_age_hours_at_capture,
    DATE_DIFF('second', r.captured_at, r.estimated_restore) / 3600.0 AS restore_eta_hours_at_capture,
